        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Services_ProductCategories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SpareParts_ProductCategories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "ProductCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VehicleNames_Brands_BrandId",
                        column: x => x.BrandId,
                        principalTable: "Brands",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    VehicleNameId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VehicleVariants_VehicleNames_VehicleNameId",
                        column: x => x.VehicleNameId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VehicleModelYears", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VehicleModelYears_VehicleVariants_VehicleVariantId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VehicleModelYearId = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SparePartCompatibilities_VehicleModelYears_VehicleModelYearId",
                        column: x => x.VehicleModelYearId,
                        principalTable: "VehicleModelYears",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SparePartCompatibilities_VehicleNames_VehicleNameId",
                        column: x => x.VehicleNameId,
                        principalTable: "VehicleNames",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SparePartCompatibilities_VehicleVariants_VehicleVariantId",
                        column: x => x.VehicleVariantId,
                        principalTable: "VehicleVariants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BrandId = table.Column<int>(type: "int", nullable: false),
                    VehicleNameId = table.Column<int>(type: "int", nullable: true),
                    VehicleVariantId = table.Column<int>(type: "int", nullable: true),
                    VehicleModelYearId = table.Column<int>(type: "int", nullable: true),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VehicleType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Vehicles_VehicleModelYears_VehicleModelYearId",
                        column: x => x.VehicleModelYearId,
                        principalTable: "VehicleModelYears",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Vehicles_VehicleNames_VehicleNameId",
                        column: x => x.VehicleNameId,
                        principalTable: "VehicleNames",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductCategories_CategoryType_Code",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SparePartCompatibilities_VehicleModelYearId",
                table: "SparePartCompatibilities",
                column: "VehicleModelYearId");

            migrationBuilder.CreateIndex(
                name: "IX_SparePartCompatibilities_VehicleNameId",
                table: "SparePartCompatibilities",
                column: "VehicleNameId");

            migrationBuilder.CreateIndex(
                name: "IX_SparePartCompatibilities_VehicleVariantId",
                table: "SparePartCompatibilities",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleModelYears_VehicleVariantId_Year",
                table: "VehicleModelYears",
                columns: new[] { "VehicleVariantId", "Year" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_VehicleNames_BrandId_NormalizedName",
                table: "VehicleNames",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vehicles_VehicleModelYearId",
                table: "Vehicles",
                column: "VehicleModelYearId");

            migrationBuilder.CreateIndex(
                name: "IX_Vehicles_VehicleNameId",
                table: "Vehicles",
                column: "VehicleNameId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleVariants_VehicleNameId_Name",
                table: "VehicleVariants",
                columns: new[] { "VehicleNameId", "Name" },
                unique: true);
        }
