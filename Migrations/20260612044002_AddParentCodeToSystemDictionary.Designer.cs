...
namespace AutoHub.Migrations
{
    ...
    [Migration("20260612044002_AddParentCodeToSystemDictionary")]
    partial class AddParentCodeToSystemDictionary
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AutoHub.Models.Entities.District", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AutoHub.Models.Entities.Province", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AutoHub.Models.Entities.Showroom", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AutoHub.Models.Entities.SocialPost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AutoHub.Models.Entities.Ward", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AutoHub.Models.Entities.District", b =>
                {
                    b.HasOne("AutoHub.Models.Entities.Province", "Province")
                        .WithMany("Districts")
            ...
            modelBuilder.Entity("AutoHub.Models.Entities.Ward", b =>
                {
                    b.HasOne("AutoHub.Models.Entities.District", "District")
                        .WithMany("Wards")
